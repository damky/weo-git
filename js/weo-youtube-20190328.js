...
jQuery(document).ready(function($){
    ...
    window.onYouTubeIframeAPIReady = function() {
        ...
        // This will rewind the background video banner when it gets close to the end. code in part from stackoverflow user Zortext - https://stackoverflow.com/users/2572967/zortext
        // https://stackoverflow.com/questions/46635316/youtube-embedded-video-auto-loop-without-refresh-screen
        var bkgVidID = document.querySelectorAll('[data-vidID]')[0].dataset.vidid;
        var bkgPlayer; 
        bkgPlayer = new YT.Player('TPbkgVid', {
            videoId: bkgVidID, 
            playerVars: {
                modestbranding: 0, 
                autoplay: 1, 
            ...
            events: {
                ...
                'onStateChange': function (event) {
                    ...
                    if(event.data===1){
                        var remains=ytPlayer.getDuration() - ytPlayer.getCurrentTime(); 
                        if(this.rewindTO) clearTimeout(this.rewindTO); 
                        this.rewindTO=setTimeout(function(){
                            ytPlayer.seekTo(0); },(remains-0.1)*1000); 
                    } 
                } 
            } 
        });
